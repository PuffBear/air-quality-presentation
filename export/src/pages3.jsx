...
function ClusterPage() {
  ...
  return (
    <div className="page">
      ...
      <div className="card">
        <div className="chart-wrap"><img src={window.__resources.img12} alt="Clustering"/></div>
  ...
  return (
    <div className="page">
      ...
      <div className="card" style={{marginTop:14}}>
        ...
        <div className="chart-wrap"><img src={window.__resources.img14} alt="Predictive models"/></div>
      </div>
    </div>
  );
}
