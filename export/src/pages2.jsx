...
function CorrelationPage() {
  ...
  return (
    <div className="page">
      ...
      <div className="card">
        <div className="chart-wrap"><img src={window.__resources.img07} alt="Scatter"/></div>
        <div className="chart-caption">
      ...
      <div className="card">
        <div className="chart-wrap"><img src={window.__resources.img10} alt="Hypothesis tests"/></div>
        <div className="chart-caption">
...
function SeasonalityPage() {
  ...
  return (
    <div className="page">
      ...
      <div className="card">
        <div className="chart-wrap"><img src={window.__resources.img13} alt="Time series decomposition"/></div>
        <div className="chart-caption">
      ...
      <div className="card">
        <div className="chart-wrap"><img src={window.__resources.img08} alt="Temporal trends"/></div>
        <div className="chart-caption">
