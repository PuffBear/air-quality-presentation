    ...
    <div className="page">
      ...
      <div className="two-col">
        <div className="card">
          ...
          <div className="chart-wrap"><img src="assets/01_missing_values.png" alt="Missing values"/></div>
        </div>
        <div className="card">
          ...
          <div className="chart-wrap"><img src="assets/02_outliers_boxplot.png" alt="Outlier boxplots"/></div>
        </div>
      </div>
  ...
  return (
    <div className="page">
      ...
      <div className="card" style={{marginTop:16}}>
        ...
        <div className="chart-wrap"><img src="assets/03_aq_distributions.png" alt="Distributions"/></div>
      </div>
